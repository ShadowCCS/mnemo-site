...
async function initializeSearchIndex() {
    const docPaths = [
        ...
        'docs/content/developers/making-extensions.html',
        'docs/content/developers/making-games.html',
        'docs/content/developers/publishing.html',
        'docs/content/Core Features/games.html',
        'docs/content/support/troubleshooting.html',
        'docs/content/support/faq.html',
        'docs/content/support/contact-support.html'
    ];
...
function initializeArticleInteractions(article) {
    ...
    // Initialize image modal functionality for this article
    const images = article.querySelectorAll('.article-image');
    const modal = document.getElementById('imageModal');
    const modalImg = document.getElementById('modalImage');
    const captionText = document.getElementById('modalCaption');
...
async function navigateToSection(sectionId, behavior = 'smooth') {
    ...
    const sectionToArticleMap = {
        ...
        'making-extensions': 'docs/content/developers/making-extensions.html',
        'making-games': 'docs/content/developers/making-games.html',
        'publishing': 'docs/content/developers/publishing.html',
        'games': 'docs/content/Core Features/games.html',
        'troubleshooting': 'docs/content/support/troubleshooting.html',
        'faq': 'docs/content/support/faq.html',
        'contact-support': 'docs/content/support/contact-support.html',
